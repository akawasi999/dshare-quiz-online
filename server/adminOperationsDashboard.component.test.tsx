...
vi.mock("@/lib/trpc", () => ({ trpc: { admin: { overview: { useQuery: () => mocks.overview }, analytics: { useQuery: () => mocks.analytics }, reports: { useQuery: () => mocks.reports }, auditTrail: { useQuery: () => mocks.audit } } } }));
