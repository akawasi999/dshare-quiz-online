...
export const appRouter = router({
  ...
  admin: router({
    ...
    saveQuestion: adminProcedure.input(z.object({
      ...
      type: z.enum(["single", "multiple", "true_false", "fill_blank", "image", "matching", "essay"]),
