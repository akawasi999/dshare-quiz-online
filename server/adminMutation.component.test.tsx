...
const mocks = vi.hoisted(() => ({
  users: { data: { items: [{ user: { id: 4, name: "Người làm bài", email: "participant@example.com", openId: "user-4", createdAt: new Date() }, profile: { tier: "basic", pointBalance: 0, isBanned: false }, completedCount: 0 }], total: 1, page: 1, pageSize: 12, totalPages: 1 }, isLoading: false, refetch: vi.fn() },
...
describe("Admin mutation feedback", () => {
  ...
  it("công bố lỗi khi không thể thay đổi hạng thành viên", async () => {
    ...
    await user.selectOptions(screen.getAllByLabelText("Gói của Người làm bài")[0], "pro");
