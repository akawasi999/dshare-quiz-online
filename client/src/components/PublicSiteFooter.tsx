...
export default function PublicSiteFooter() {
  ...
  const getSocialColors = (platform: typeof footer.socialLinks[number]["platform"]) => footer.socialStyle.colorMode === "platform" ? socialColorPresets[platform] : footer.socialStyle;
