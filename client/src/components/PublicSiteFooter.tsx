  ...
  return <footer className={`public-site-footer ${footer.shadow ? "public-site-footer-shadow" : ""} ${footer.border ? "public-site-footer-border" : ""}`} style={{ minHeight: footer.height, backgroundColor: config.colors.footer, ["--footer-column-count" as string]: footer.columns } as React.CSSProperties}>
    <div className="container py-10 sm:py-12">
      ...
      <div className="mt-9 flex flex-wrap items-center justify-between gap-3 border-t border-white/15 pt-5 text-xs text-white/55">
        <div className="flex flex-wrap items-center gap-x-4 gap-y-2"><span>{footer.copyright}</span><nav aria-label="Thông tin pháp lý" className="flex items-center gap-3"><a href="/terms" className="transition-colors hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white">Điều khoản sử dụng</a><a href="/privacy" className="transition-colors hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white">Chính sách bảo mật</a></nav></div>
