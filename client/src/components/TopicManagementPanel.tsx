...
export default function TopicManagementPanel() {
  ...
  return <div className="mx-auto max-w-7xl space-y-6">
    <header className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between"><p className="text-[10px] font-bold uppercase tracking-[.15em] text-primary">Learning</p><Button onClick={() => openCreate()} className="cta-gradient"><Plus size={16} />Tạo Chủ đề</Button></header>
