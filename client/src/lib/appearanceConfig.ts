...
export function mergeAppearanceConfig(value: unknown): AppearanceConfig {
  ...
  return {
    ...
    footer: { ...mergedFooter, linkGroups: candidateFooter && !Array.isArray(candidateFooter.linkGroups) && legacyFooterLinks ? [{ id: "information", title: "Thông tin", links: legacyFooterLinks }] : mergedFooter.linkGroups, socialLinks: Array.isArray(candidateFooter?.socialLinks) ? candidateFooter.socialLinks : defaultAppearanceConfig.footer.socialLinks, socialStyle: { ...defaultAppearanceConfig.footer.socialStyle, ...candidateFooter?.socialStyle } },
