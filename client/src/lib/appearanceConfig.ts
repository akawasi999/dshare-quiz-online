export type AppearanceConfig = {
  ...
  footer: { enabled: boolean; height: number; width: "container" | "full"; shadow: boolean; border: boolean; columns: 1 | 2 | 3 | 4; description: string; copyright: string; showThemeSwitcher: boolean; links: Array<{ label: string; url: string; enabled: boolean; icon?: FooterLinkIcon }>; linkGroups: Array<{ id: string; title: string; links: Array<{ label: string; url: string; enabled: boolean; icon?: FooterLinkIcon }> }>; socialLinks: Array<{ platform: FooterSocialPlatform; url: string; enabled: boolean }>; socialStyle: { shape: "round" | "square"; backgroundColor: string; iconColor: string } };
