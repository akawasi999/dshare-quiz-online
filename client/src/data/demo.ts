...
export const pricingPlans = [
  { name: "Gói Miễn phí", tier: "Basic", price: "Miễn phí", description: "", benefits: [{ label: "AI Credits tặng kèm (Point)", value: "20" }, { label: "Lượt thi tối đa/tháng", value: "20" }, { label: "Số Quiz được tạo", value: "2" }, { label: "Phân tích Leads", value: "Không" }, { label: "Tải file báo cáo", value: "Không" }, { label: "Upload câu hỏi bằng AI", value: "Không" }, { label: "Live Monitoring", value: "Không" }, { label: "Hỗ trợ ưu tiên", value: "Không" }, { label: "Tùy chỉnh thương hiệu", value: "Không" }], highlighted: false },
  { name: "Gói PRO", tier: "Pro", price: "50.000đ", description: "", benefits: [{ label: "AI Credits tặng kèm (Point)", value: "200" }, { label: "Lượt thi tối đa/tháng", value: "40" }, { label: "Số Quiz được tạo", value: "20" }, { label: "Phân tích Leads", value: "Có" }, { label: "Tải file báo cáo", value: "Có" }, { label: "Upload câu hỏi bằng AI", value: "Có" }, { label: "Live Monitoring", value: "Có" }, { label: "Hỗ trợ ưu tiên", value: "Có" }, { label: "Tùy chỉnh thương hiệu", value: "Có" }], highlighted: true },
  { name: "Gói PREMIUM", tier: "Premium", price: "100.000đ", description: "", benefits: [{ label: "AI Credits tặng kèm (Point)", value: "500" }, { label: "Lượt thi tối đa/tháng", value: "50" }, { label: "Số Quiz được tạo", value: "Vô hạn" }, { label: "Phân tích Leads", value: "Có" }, { label: "Tải file báo cáo", value: "Có" }, { label: "Upload câu hỏi bằng AI", value: "Có" }, { label: "Live Monitoring", value: "Có" }, { label: "Hỗ trợ ưu tiên", value: "Có" }, { label: "Tùy chỉnh thương hiệu", value: "Có" }], highlighted: false },
];
