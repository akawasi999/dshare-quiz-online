...
export const pricingPlans = [
  { name: "Gói Miễn phí", tier: "Basic", price: "Miễn phí", description: "Khởi đầu để khám phá và luyện tập các nội dung thiết yếu.", benefits: [{ label: "AI Credits tặng kèm", value: "20" }, { label: "Lượt thi tối đa/tháng", value: "100" }, { label: "Số Quiz được tạo", value: "5" }, { label: "Phân tích Leads", value: "Không" }, { label: "Tải file báo cáo", value: "Không" }, { label: "Upload câu hỏi bằng AI", value: "Không" }, { label: "Live Monitoring", value: "Không" }, { label: "Hỗ trợ ưu tiên", value: "Không" }, { label: "Tùy chỉnh thương hiệu", value: "Không" }], highlighted: false },
  { name: "Standard", tier: "Pro", price: "50.000đ", description: "Hạng Pro: mở rộng năng lực luyện tập và quản trị nội dung.", benefits: [{ label: "AI Credits tặng kèm", value: "200" }, { label: "Lượt thi tối đa/tháng", value: "Vô hạn" }, { label: "Số Quiz được tạo", value: "Vô hạn" }, { label: "Phân tích Leads", value: "Có" }, { label: "Tải file báo cáo", value: "Có" }, { label: "Upload câu hỏi bằng AI", value: "Có" }, { label: "Live Monitoring", value: "Có" }, { label: "Hỗ trợ ưu tiên", value: "Có" }, { label: "Tùy chỉnh thương hiệu", value: "Có" }], highlighted: true },
  { name: "Gói PRO", tier: "Premium", price: "100.000đ", description: "Hạng Premium: toàn bộ quyền lợi Standard với AI Credits cao hơn.", benefits: [{ label: "AI Credits tặng kèm", value: "500" }, { label: "Lượt thi tối đa/tháng", value: "Vô hạn" }, { label: "Số Quiz được tạo", value: "Vô hạn" }, { label: "Phân tích Leads", value: "Có" }, { label: "Tải file báo cáo", value: "Có" }, { label: "Upload câu hỏi bằng AI", value: "Có" }, { label: "Live Monitoring", value: "Có" }, { label: "Hỗ trợ ưu tiên", value: "Có" }, { label: "Tùy chỉnh thương hiệu", value: "Có" }], highlighted: false },
];
