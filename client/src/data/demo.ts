...
export const showcaseQuizzes: ShowcaseQuiz[] = [
  {
    ...
    category: "Công nghệ", subject: "Lập trình Python", lesson: "Chương 01", difficulty: "Dễ", mode: "Ôn tập", questionCount: 20, duration: "25 phút", points: 0, reward: 30, tier: "Basic", accent: "#B8964C",
  },
  {
    id: 102,
    ...
    category: "Công nghệ", subject: "Phân tích dữ liệu", lesson: "Chương 02", difficulty: "Trung bình", mode: "Kiểm tra", questionCount: 30, duration: "35 phút", points: 50, reward: 80, tier: "Pro", accent: "#639D99",
  },
  {
    id: 103,
    ...
    category: "Ngoại ngữ", subject: "IELTS Writing", lesson: "Bài 05", difficulty: "Trung bình", mode: "Ôn tập", questionCount: 24, duration: "30 phút", points: 0, reward: 40, tier: "Basic", accent: "#806C95",
  },
  {
    id: 104,
    ...
    category: "Kỹ năng", subject: "Tư duy phản biện", lesson: "Bài 03", difficulty: "Nâng cao", mode: "Kiểm tra", questionCount: 25, duration: "40 phút", points: 75, reward: 120, tier: "Premium", accent: "#B96A56",
  },
];

export const progressPreview = [
  { label: "Lập trình Python", value: 72, accent: "#D4B97A" },
  { label: "IELTS Writing", value: 46, accent: "#7399A6" },
  { label: "Tư duy phản biện", value: 31, accent: "#A7776F" },
];
