...
export default function Practice() {
  ...
  if (!item) return <PracticeShell><MessageCard icon="success" title="Chưa có câu cần ôn" description="Hãy hoàn thành một bộ đề; các câu chưa đúng sẽ xuất hiện tại đây để bạn luyện lại." action={<Button asChild className="mt-6 rounded-full bg-[#172554]"><Link href={practiceCompletionDestination}>Khám phá bộ đề</Link></Button>} /></PracticeShell>;
