...
export default function Referral() {
  ...
  const apply = trpc.learner.applyReferralCode.useMutation({
    onSuccess: result => { referral.refetch(); setCode(""); toast.success(`Đã nhận ${result.recipientReward} Point chào mừng.`); },
