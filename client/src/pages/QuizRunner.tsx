...
type ActiveQuestion = { id: number; prompt: string; type: string; difficulty: string; tags: string[]; explanation?: string | null; options: { id: number; body: string }[]; correctOptionIds?: number[]; media?: { url: string; kind: "audio" | "video"; fileName: string } | null };
