...
- [x] Kiểm kê layout Tạo Quiz, thanh AI/Point/liên kết và xác định nguyên nhân chồng chéo.
...
- [x] Tiếp tục hoàn thiện các hạng mục PDF, báo cáo giáo viên và Quiz AI theo update.pdf từ checkpoint Privacy Guard.
...
- [x] Gỡ “Khám phá có định hướng” và đồng bộ “Bộ đề được quan tâm” của trang chủ với dữ liệu Khám phá.
